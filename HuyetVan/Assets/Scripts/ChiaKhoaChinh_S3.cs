...
public class ChiaKhoaChinh_S3 : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            {
                dungGan = true;
                if (vungChu != null) { vungChu.gameObject.SetActive(true); vungChu.text = "Bấm [E] nhặt Chìa Khóa Cổng Chính"; }
            }
        }
    }
    ...
    void Update()
    {
        ...
        {
            baloNhanVat.NhatChiaKhoaChinh(); // Báo cho Balo
